...
public class ContactItemRecyclerViewAdapter extends RecyclerView.Adapter<ContactItemRecyclerViewAdapter.ViewHolder> {
    ...
    public ContactItemRecyclerViewAdapter(List<ContentItem> items, OnListFragmentInteractionListener listener, GestureDetectorCompat detector) {
        mValues = items;
        mListener = listener;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_whats_app_contact_item, parent, false);
